    ...
    return (
        <>
            <div className='overflow-hidden -z-50'>
                ...
                <footer class="bg-white p-3 border-t-[1px]">
                    <div class="container px-6 py-8 mx-auto">
                        <div class="flex flex-col items-center text-center">
                            ...
                            <div class="flex flex-wrap justify-center mt-6 text-lg font-semibold font-Rubik">
                                <Link to="/home" class="mx-4  text-gray-600 transition-colors duration-300 hover:text-blue-500 " aria-label="Reddit"> Home </Link>

                                <Link to="/aboutus" class="mx-4  text-gray-600 transition-colors duration-300 hover:text-blue-500" aria-label="Reddit"> About </Link>

                                <Link to="/teams" class="mx-4  text-gray-600 transition-colors duration-300 hover:text-blue-500 " aria-label="Reddit"> Teams </Link>

                                <Link to="/matches" class="mx-4  text-gray-600 transition-colors duration-300 hover:text-blue-500 " aria-label="Reddit"> Matches</Link>

                                <Link to="/contact" class="mx-4  text-gray-600 transition-colors duration-300 hover:text-blue-500 " aria-label="Reddit">Contact us</Link>
                            </div>
