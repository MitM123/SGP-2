...
const WicketModal = ({ open }) => {
  ...
  console.log("okpfengdsopn", scorePanelContext.upcomingStrikers)
  return (
    <>
      <Modal open={open} >
        <ModalDialog sx={{ width: '27%', height: '40%', padding: '0', '@media(max-width:680px)': { height: '10%' }, '@media(max-width:420px)': { height: '13%' } }}>
          ...
          <div className='flex h-40 flex-row gap-x-2 justify-center font-poppins items-center m-2 '>
            <Select
              name='nextStriker'
