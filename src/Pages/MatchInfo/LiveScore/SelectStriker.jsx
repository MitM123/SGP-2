...
const SelectStriker = () => {
    ...
    return (
        <>
            <React.Fragment>
                <button onClick={() => setOpen(true)} className='text-white bg-emerald-500 text-md   font-Outfit items-center flex  justify-center p-2 rounded-lg w-28 '>LET'S PLAY</button>
                <Modal open={open} >
